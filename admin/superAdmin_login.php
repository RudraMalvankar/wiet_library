...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($admin && $admin['is_superadmin']) {
        ...
        $_SESSION['admin_id'] = 'SUPERADM2024001';
        ...
        $error_message = "Invalid credentials or insufficient privileges. Only Super Admins can access this login.";
    }
}
?>
...
<head>
    ...
    <title>Super Admin Login - WIET Library</title>
